 ...
 * Use the [CloudMqttFragment.newInstance] factory method to
...
class CloudMqttFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_cloud_mqtt, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CloudMqttFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                CloudMqttFragment().apply {
